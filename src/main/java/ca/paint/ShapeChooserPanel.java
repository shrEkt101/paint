...
public class ShapeChooserPanel extends GridPane implements EventHandler<ActionEvent> {
        ...
        public ShapeChooserPanel(View view) {
                ...
                String[] imagePaths = {
                        getClass().getResource("/ca/images/circle.png").toExternalForm(),
                        getClass().getResource("/ca/images/rectangle.png").toExternalForm(),
                        getClass().getResource("/ca/images/square.png").toExternalForm(),
                        getClass().getResource("/ca/images/squiggle.png").toExternalForm(),
                        getClass().getResource("/ca/images/polyline.png").toExternalForm(),
                        getClass().getResource("/ca/images/oval.png").toExternalForm(),
                        getClass().getResource("/ca/images/Triangle.png").toExternalForm()
                };
                int row = 0;
